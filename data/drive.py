...
class DatasetDRIVE(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        img, anno_mask, anno_boundary, ignore_mask, org_img_size = self.load_frame(img_name)

        if self.split == 'train':
            img, anno_mask, anno_boundary, ignore_mask = self.augmentation(img, anno_mask, anno_boundary, ignore_mask)
